    ...
    >
      <div className="container-fluid">
        <div className="d-block">
          <h1 className="fw-bold mb-3" style={{ fontSize: "3.4rem" }}>
            {"<Code-ite/>"}
          </h1>
          <p className="fs-5 fw-light lh-sm mt-4">
            {" "}
            Create private rooms and code.
            <br />
            White board also included so that you don't
            <br />
            miss out on logics...
            <br />
          </p>
          ...
          {joinForm ? (
            <div className="mt-5">
              <input
                type="text"
                className="form-control  px-4 py-2 w-75"
              ...
              <button
                ...
                className="btn btn-outline-dark mx-4  px-4 py-3 rounded-0"
              >{`< Back`}</button>
            </div>
          ) : (
            <div className="mt-5">
              <Link to="/join">
                <button className="btn btn-dark px-3 py-3 rounded-0 ">
                  {" "}
                  <i className="far fa-plus-square"></i> Create Room
                </button>
              </Link>
              <button
                onClick={() => setJoinForm(!joinForm)}
