                ...
                <div className="d-block" >
                    ...
                    {joinForm ?
                        <div className="mt-5">
                            ...
                            <button onClick={() => (navigate(`/room/${joinFormValue.current.value}`))} className="btn btn-dark my-4 px-4 py-3 rounded-0 white-btn"><i className="fas fa-sign-in-alt"></i> Enter Room</button>
                        ...
                        <div className="mt-5">
                            ...
                            <button onClick={() => (setJoinForm(!joinForm))} className="btn btn-outline-dark my-2 ms-3 justify-between  px-3 py-3 rounded-0 black-btn"><i className="fas fa-sign-in-alt"></i> Join Room</button>
                        </div>
                    }
                </div>
            </div>
